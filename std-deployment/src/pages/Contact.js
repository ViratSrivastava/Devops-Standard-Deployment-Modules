  ...
  return (
    <div className="p-8">
      ...
      <section className="mb-8">
        ...
        <a href="https://github.com/ViratSrivastava" className="text-blue-400 hover:underline">
          View on GitHub
        </a>
      </section>
      <section className="mb-8">
      ...
      <section className="mb-8">
        ...
        <div className="flex space-x-4">
          <a href="https://linkedin.com/in/virat-srivastava" className="text-blue-400 hover:underline">LinkedIn</a>
          <a href="https://github.com/ViratSrivastava" className="text-blue-400 hover:underline">GitHub</a>
        </div>
      </section>
    </div>
  );
